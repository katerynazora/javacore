 ...
 */
public class CrawlerTractor extends Traktor{
    private String name;
    private int speed;
    private int weight;
    ...
    public CrawlerTractor(String nameMashine, int speedRunAtTHisMoment, int numberOfPeople, int numberOfWheel, int weight) {
